...
public class KeyboardEventDispatchExtensionsBunit : EventDispatchExtensionsBunit<KeyboardEventArgs>
{
	public KeyboardEventDispatchExtensionsBunit(ITestOutputHelper outputHelper) : base(outputHelper)
	{
	}
