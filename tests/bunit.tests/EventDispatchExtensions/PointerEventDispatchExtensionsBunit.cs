...
public class PointerEventDispatchExtensionsBunit : EventDispatchExtensionsBunit<PointerEventArgs>
{
	public PointerEventDispatchExtensionsBunit(ITestOutputHelper outputHelper) : base(outputHelper)
	{
	}
