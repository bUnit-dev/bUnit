...
public class GeneralEventDispatchExtensionsBunit : EventDispatchExtensionsBunit<EventArgs>
{
	protected override string ElementName => "p";

	public GeneralEventDispatchExtensionsBunit(ITestOutputHelper outputHelper)
		: base(outputHelper)
	{
