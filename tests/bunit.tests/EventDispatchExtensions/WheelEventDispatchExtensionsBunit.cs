...
public class WheelEventDispatchExtensionsBunit : EventDispatchExtensionsBunit<WheelEventArgs>
{
	public WheelEventDispatchExtensionsBunit(ITestOutputHelper outputHelper) : base(outputHelper)
	{
	}
