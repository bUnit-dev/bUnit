...
public class InputEventDispatchExtensionsBunit : EventDispatchExtensionsBunit<ChangeEventArgs>
{
	...
	public InputEventDispatchExtensionsBunit(ITestOutputHelper outputHelper) : base(outputHelper)
	{
	}
