...
public class TouchEventDispatchExtensionsBunit : EventDispatchExtensionsBunit<TouchEventArgs>
{
	public TouchEventDispatchExtensionsBunit(ITestOutputHelper outputHelper) : base(outputHelper)
	{
	}
