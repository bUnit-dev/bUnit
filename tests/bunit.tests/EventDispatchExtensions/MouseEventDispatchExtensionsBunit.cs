...
public class MouseEventDispatchExtensionsBunit : EventDispatchExtensionsBunit<MouseEventArgs>
{
	public MouseEventDispatchExtensionsBunit(ITestOutputHelper outputHelper) : base(outputHelper)
	{
	}
