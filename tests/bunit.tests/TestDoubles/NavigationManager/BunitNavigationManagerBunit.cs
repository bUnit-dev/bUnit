...
public class BunitNavigationManagerBunit : BunitContext
{
	private BunitNavigationManager CreateNavigationManager()
		=> Services.GetRequiredService<BunitNavigationManager>();

	[Fact(DisplayName = "BunitContext.Services has NavigationManager registered by default as BunitNavigationManager")]
	public void Test001()
	{
