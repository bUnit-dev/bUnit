...
namespace Bunit
{
	...
	/// A test context is a factory that makes it possible to create components under tests.
	/// </summary>
	public interface IWebTestContext : ITestContext
	{
		/// <summary>
		...
		IWebRenderedComponent<TComponent> RenderComponent<TComponent>(params ComponentParameter[] parameters) where TComponent : IComponent;
	}
}
