...
namespace Bunit
{
	...
	/// </summary>
	public class TestContext : IWebTestContext, IDisposable
	{
		...
		/// <inheritdoc/>
		public virtual IWebRenderedComponent<TComponent> RenderComponent<TComponent>(params ComponentParameter[] parameters) where TComponent : IComponent
		{
