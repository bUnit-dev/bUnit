...
namespace Bunit
{
	...
	public static class PointerEventDispatchExtensions
	{
		...
		public static void GotPointerCapture(this IElement element, long detail = default, double screenX = default, double screenY = default, double clientX = default, double clientY = default, long button = default, long buttons = default, bool ctrlKey = default, bool shiftKey = default, bool altKey = default, bool metaKey = default, string? type = default,
			long pointerId = default, float width = default, float height = default, float pressure = default, float tiltX = default, float tiltY = default, string? pointerType = default, bool isPrimary = default)
		...
		/// pen or touch, or an empty string.</param>
		/// <param name="isPrimary">Indicates if the pointer represents the primary pointer of this pointer type.</param>
		public static void LostPointerCapture(this IElement element, long detail = default, double screenX = default, double screenY = default, double clientX = default, double clientY = default, long button = default, long buttons = default, bool ctrlKey = default, bool shiftKey = default, bool altKey = default, bool metaKey = default, string? type = default,
			long pointerId = default, float width = default, float height = default, float pressure = default, float tiltX = default, float tiltY = default, string? pointerType = default, bool isPrimary = default)
		...
		public static void PointerDown(this IElement element,
						long detail = default, double screenX = default, double screenY = default, double clientX = default, double clientY = default, long button = default, long buttons = default, bool ctrlKey = default, bool shiftKey = default, bool altKey = default, bool metaKey = default, string? type = default,
			long pointerId = default, float width = default, float height = default, float pressure = default, float tiltX = default, float tiltY = default, string? pointerType = default, bool isPrimary = default)
		...
		/// <param name="eventArgs"></param>
		/// <returns>A task that completes when the event handler is done.</returns>
		private static Task PointerDownAsync(this IElement element, PointerEventArgs eventArgs) => element.TriggerEventAsync("onpointerdown", eventArgs);        //[EventHandler("onpointercancel", typeof(PointerEventArgs), true, true)]
		...
		/// pen or touch, or an empty string.</param>
		/// <param name="isPrimary">Indicates if the pointer represents the primary pointer of this pointer type.</param>
		public static void PointerMove(this IElement element, long detail = default, double screenX = default, double screenY = default, double clientX = default, double clientY = default, long button = default, long buttons = default, bool ctrlKey = default, bool shiftKey = default, bool altKey = default, bool metaKey = default, string? type = default,
			long pointerId = default, float width = default, float height = default, float pressure = default, float tiltX = default, float tiltY = default, string? pointerType = default, bool isPrimary = default)
		...
		/// pen or touch, or an empty string.</param>
		/// <param name="isPrimary">Indicates if the pointer represents the primary pointer of this pointer type.</param>
		public static void PointerOut(this IElement element, long detail = default, double screenX = default, double screenY = default, double clientX = default, double clientY = default, long button = default, long buttons = default, bool ctrlKey = default, bool shiftKey = default, bool altKey = default, bool metaKey = default, string? type = default,
			long pointerId = default, float width = default, float height = default, float pressure = default, float tiltX = default, float tiltY = default, string? pointerType = default, bool isPrimary = default)
		...
		/// pen or touch, or an empty string.</param>
		/// <param name="isPrimary">Indicates if the pointer represents the primary pointer of this pointer type.</param>
		public static void PointerOver(this IElement element, long detail = default, double screenX = default, double screenY = default, double clientX = default, double clientY = default, long button = default, long buttons = default, bool ctrlKey = default, bool shiftKey = default, bool altKey = default, bool metaKey = default, string? type = default,
			long pointerId = default, float width = default, float height = default, float pressure = default, float tiltX = default, float tiltY = default, string? pointerType = default, bool isPrimary = default)
		...
		/// pen or touch, or an empty string.</param>
		/// <param name="isPrimary">Indicates if the pointer represents the primary pointer of this pointer type.</param>
		public static void PointerUp(this IElement element, long detail = default, double screenX = default, double screenY = default, double clientX = default, double clientY = default, long button = default, long buttons = default, bool ctrlKey = default, bool shiftKey = default, bool altKey = default, bool metaKey = default, string? type = default,
			long pointerId = default, float width = default, float height = default, float pressure = default, float tiltX = default, float tiltY = default, string? pointerType = default, bool isPrimary = default)
