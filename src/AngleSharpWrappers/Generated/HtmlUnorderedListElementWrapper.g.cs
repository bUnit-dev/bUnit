...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlUnorderedListElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlUnorderedListElementWrapper : Wrapper<IHtmlUnorderedListElement>, IHtmlUnorderedListElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlUnorderedListElementWrapper"/> type;
        /// </summary>
        public HtmlUnorderedListElementWrapper(IElementFactory<IHtmlUnorderedListElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
