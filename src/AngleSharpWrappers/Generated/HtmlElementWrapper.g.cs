...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlElementWrapper : Wrapper<IHtmlElement>, IHtmlElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlElementWrapper"/> type;
        /// </summary>
        public HtmlElementWrapper(IElementFactory<IHtmlElement> elementFactory) : base(elementFactory) { }
