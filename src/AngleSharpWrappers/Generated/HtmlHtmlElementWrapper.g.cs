...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlHtmlElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlHtmlElementWrapper : Wrapper<IHtmlHtmlElement>, IHtmlHtmlElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlHtmlElementWrapper"/> type;
        /// </summary>
        public HtmlHtmlElementWrapper(IElementFactory<IHtmlHtmlElement> elementFactory) : base(elementFactory) { }
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? Manifest { get => WrappedElement.Manifest; set => WrappedElement.Manifest = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
