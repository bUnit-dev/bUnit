...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlHeadElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlHeadElementWrapper : Wrapper<IHtmlHeadElement>, IHtmlHeadElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlHeadElementWrapper"/> type;
        /// </summary>
        public HtmlHeadElementWrapper(IElementFactory<IHtmlHeadElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
