...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlParamElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlParamElementWrapper : Wrapper<IHtmlParamElement>, IHtmlParamElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlParamElementWrapper"/> type;
        /// </summary>
        public HtmlParamElementWrapper(IElementFactory<IHtmlParamElement> elementFactory) : base(elementFactory) { }
