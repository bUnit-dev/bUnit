...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlDetailsElementWrapper : Wrapper<IHtmlDetailsElement>, IHtmlDetailsElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlDetailsElementWrapper"/> type;
        /// </summary>
        public HtmlDetailsElementWrapper(IElementFactory<IHtmlDetailsElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean IsOpen { get => WrappedElement.IsOpen; set => WrappedElement.IsOpen = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
