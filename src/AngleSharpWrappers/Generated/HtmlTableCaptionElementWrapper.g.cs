...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlTableCaptionElementWrapper : Wrapper<IHtmlTableCaptionElement>, IHtmlTableCaptionElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTableCaptionElementWrapper"/> type;
        /// </summary>
        public HtmlTableCaptionElementWrapper(IElementFactory<IHtmlTableCaptionElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
