...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTimeElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlTimeElementWrapper : Wrapper<IHtmlTimeElement>, IHtmlTimeElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTimeElementWrapper"/> type;
        /// </summary>
        public HtmlTimeElementWrapper(IElementFactory<IHtmlTimeElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
