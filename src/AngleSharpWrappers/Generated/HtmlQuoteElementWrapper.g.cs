...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlQuoteElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlQuoteElementWrapper : Wrapper<IHtmlQuoteElement>, IHtmlQuoteElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlQuoteElementWrapper"/> type;
        /// </summary>
        public HtmlQuoteElementWrapper(IElementFactory<IHtmlQuoteElement> elementFactory) : base(elementFactory) { }
