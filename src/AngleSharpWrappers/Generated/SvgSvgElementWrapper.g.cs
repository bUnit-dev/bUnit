...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="ISvgSvgElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class SvgSvgElementWrapper : Wrapper<ISvgSvgElement>, ISvgSvgElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="SvgSvgElementWrapper"/> type;
        /// </summary>
        public SvgSvgElementWrapper(IElementFactory<ISvgSvgElement> elementFactory) : base(elementFactory) { }
