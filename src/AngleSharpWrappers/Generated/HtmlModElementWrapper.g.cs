...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlModElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlModElementWrapper : Wrapper<IHtmlModElement>, IHtmlModElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlModElementWrapper"/> type;
        /// </summary>
        public HtmlModElementWrapper(IElementFactory<IHtmlModElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? Citation { get => WrappedElement.Citation; set => WrappedElement.Citation = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? DateTime { get => WrappedElement.DateTime; set => WrappedElement.DateTime = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
