...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlSpanElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlSpanElementWrapper : Wrapper<IHtmlSpanElement>, IHtmlSpanElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlSpanElementWrapper"/> type;
        /// </summary>
        public HtmlSpanElementWrapper(IElementFactory<IHtmlSpanElement> elementFactory) : base(elementFactory) { }
