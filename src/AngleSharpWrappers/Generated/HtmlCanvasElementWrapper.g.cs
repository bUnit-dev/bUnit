...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlCanvasElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlCanvasElementWrapper : Wrapper<IHtmlCanvasElement>, IHtmlCanvasElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlCanvasElementWrapper"/> type;
        /// </summary>
        public HtmlCanvasElementWrapper(IElementFactory<IHtmlCanvasElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32 Height { get => WrappedElement.Height; set => WrappedElement.Height = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32 Width { get => WrappedElement.Width; set => WrappedElement.Width = value;}
        /// <inheritdoc/>
        #endregion
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public IRenderingContext GetContext(String contextId) => WrappedElement.GetContext(contextId);
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean IsSupportingContext(String contextId) => WrappedElement.IsSupportingContext(contextId);
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public void SetContext(IRenderingContext context) => WrappedElement.SetContext(context);
        /// <inheritdoc/>
        [DebuggerHidden]
        public void ToBlob(Action<Stream> callback, String? type) => WrappedElement.ToBlob(callback, type);
        /// <inheritdoc/>
        [DebuggerHidden]
