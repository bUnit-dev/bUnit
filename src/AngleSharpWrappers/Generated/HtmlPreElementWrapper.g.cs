...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlPreElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlPreElementWrapper : Wrapper<IHtmlPreElement>, IHtmlPreElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlPreElementWrapper"/> type;
        /// </summary>
        public HtmlPreElementWrapper(IElementFactory<IHtmlPreElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
