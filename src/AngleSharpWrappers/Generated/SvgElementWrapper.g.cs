...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="ISvgElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class SvgElementWrapper : Wrapper<ISvgElement>, ISvgElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="SvgElementWrapper"/> type;
        /// </summary>
        public SvgElementWrapper(IElementFactory<ISvgElement> elementFactory) : base(elementFactory) { }
