...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTableColumnElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlTableColumnElementWrapper : Wrapper<IHtmlTableColumnElement>, IHtmlTableColumnElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTableColumnElementWrapper"/> type;
        /// </summary>
        public HtmlTableColumnElementWrapper(IElementFactory<IHtmlTableColumnElement> elementFactory) : base(elementFactory) { }
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32 Span { get => WrappedElement.Span; set => WrappedElement.Span = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
