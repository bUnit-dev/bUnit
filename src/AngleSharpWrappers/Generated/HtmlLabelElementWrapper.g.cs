...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlLabelElementWrapper : Wrapper<IHtmlLabelElement>, IHtmlLabelElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlLabelElementWrapper"/> type;
        /// </summary>
        public HtmlLabelElementWrapper(IElementFactory<IHtmlLabelElement> elementFactory) : base(elementFactory) { }
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public IHtmlElement? Control { get => WrappedElement.Control; }
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? HtmlFor { get => WrappedElement.HtmlFor; set => WrappedElement.HtmlFor = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
