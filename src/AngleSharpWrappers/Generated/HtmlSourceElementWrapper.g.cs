...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlSourceElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlSourceElementWrapper : Wrapper<IHtmlSourceElement>, IHtmlSourceElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlSourceElementWrapper"/> type;
        /// </summary>
        public HtmlSourceElementWrapper(IElementFactory<IHtmlSourceElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
