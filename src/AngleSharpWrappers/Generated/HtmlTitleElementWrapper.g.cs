...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTitleElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlTitleElementWrapper : Wrapper<IHtmlTitleElement>, IHtmlTitleElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTitleElementWrapper"/> type;
        /// </summary>
        public HtmlTitleElementWrapper(IElementFactory<IHtmlTitleElement> elementFactory) : base(elementFactory) { }
