...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlMeterElementWrapper : Wrapper<IHtmlMeterElement>, IHtmlMeterElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlMeterElementWrapper"/> type;
        /// </summary>
        public HtmlMeterElementWrapper(IElementFactory<IHtmlMeterElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Double High { get => WrappedElement.High; set => WrappedElement.High = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Double Low { get => WrappedElement.Low; set => WrappedElement.Low = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        public Double Maximum { get => WrappedElement.Maximum; set => WrappedElement.Maximum = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        public Double Minimum { get => WrappedElement.Minimum; set => WrappedElement.Minimum = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Double Optimum { get => WrappedElement.Optimum; set => WrappedElement.Optimum = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
