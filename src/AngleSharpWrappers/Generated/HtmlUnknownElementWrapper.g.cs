...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlUnknownElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlUnknownElementWrapper : Wrapper<IHtmlUnknownElement>, IHtmlUnknownElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlUnknownElementWrapper"/> type;
        /// </summary>
        public HtmlUnknownElementWrapper(IElementFactory<IHtmlUnknownElement> elementFactory) : base(elementFactory) { }
