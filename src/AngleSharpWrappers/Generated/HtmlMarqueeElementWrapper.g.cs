...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlMarqueeElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlMarqueeElementWrapper : Wrapper<IHtmlMarqueeElement>, IHtmlMarqueeElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlMarqueeElementWrapper"/> type;
        /// </summary>
        public HtmlMarqueeElementWrapper(IElementFactory<IHtmlMarqueeElement> elementFactory) : base(elementFactory) { }
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32 Loop { get => WrappedElement.Loop; set => WrappedElement.Loop = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32 MinimumDelay { get => WrappedElement.MinimumDelay; }
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32 ScrollAmount { get => WrappedElement.ScrollAmount; set => WrappedElement.ScrollAmount = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32 ScrollDelay { get => WrappedElement.ScrollDelay; set => WrappedElement.ScrollDelay = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
