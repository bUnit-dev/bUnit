...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlHrElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlHrElementWrapper : Wrapper<IHtmlHrElement>, IHtmlHrElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlHrElementWrapper"/> type;
        /// </summary>
        public HtmlHrElementWrapper(IElementFactory<IHtmlHrElement> elementFactory) : base(elementFactory) { }
