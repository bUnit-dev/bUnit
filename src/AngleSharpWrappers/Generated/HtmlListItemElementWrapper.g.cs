...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlListItemElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlListItemElementWrapper : Wrapper<IHtmlListItemElement>, IHtmlListItemElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlListItemElementWrapper"/> type;
        /// </summary>
        public HtmlListItemElementWrapper(IElementFactory<IHtmlListItemElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32? Value { get => WrappedElement.Value; set => WrappedElement.Value = value;}
        /// <inheritdoc/>
        #endregion
