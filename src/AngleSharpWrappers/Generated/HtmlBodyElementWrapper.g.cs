...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlBodyElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlBodyElementWrapper : Wrapper<IHtmlBodyElement>, IHtmlBodyElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlBodyElementWrapper"/> type;
        /// </summary>
        public HtmlBodyElementWrapper(IElementFactory<IHtmlBodyElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public event DomEventHandler HashChanged { add => WrappedElement.HashChanged += value; remove => WrappedElement.HashChanged -= value; }
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public event DomEventHandler MessageReceived { add => WrappedElement.MessageReceived += value; remove => WrappedElement.MessageReceived -= value; }
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public event DomEventHandler PageHidden { add => WrappedElement.PageHidden += value; remove => WrappedElement.PageHidden -= value; }
        /// <inheritdoc/>
        public event DomEventHandler PageShown { add => WrappedElement.PageShown += value; remove => WrappedElement.PageShown -= value; }
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public event DomEventHandler PopState { add => WrappedElement.PopState += value; remove => WrappedElement.PopState -= value; }
        /// <inheritdoc/>
        public event DomEventHandler Printed { add => WrappedElement.Printed += value; remove => WrappedElement.Printed -= value; }
        /// <inheritdoc/>
        public event DomEventHandler Printing { add => WrappedElement.Printing += value; remove => WrappedElement.Printing -= value; }
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public event DomEventHandler Storage { add => WrappedElement.Storage += value; remove => WrappedElement.Storage -= value; }
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public event DomEventHandler Unloaded { add => WrappedElement.Unloaded += value; remove => WrappedElement.Unloaded -= value; }
        /// <inheritdoc/>
        public event DomEventHandler Unloading { add => WrappedElement.Unloading += value; remove => WrappedElement.Unloading -= value; }
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public event DomEventHandler WentOffline { add => WrappedElement.WentOffline += value; remove => WrappedElement.WentOffline -= value; }
        /// <inheritdoc/>
        public event DomEventHandler WentOnline { add => WrappedElement.WentOnline += value; remove => WrappedElement.WentOnline -= value; }
        /// <inheritdoc/>
        #endregion
