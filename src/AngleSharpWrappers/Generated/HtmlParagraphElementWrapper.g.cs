...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlParagraphElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlParagraphElementWrapper : Wrapper<IHtmlParagraphElement>, IHtmlParagraphElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlParagraphElementWrapper"/> type;
        /// </summary>
        public HtmlParagraphElementWrapper(IElementFactory<IHtmlParagraphElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
