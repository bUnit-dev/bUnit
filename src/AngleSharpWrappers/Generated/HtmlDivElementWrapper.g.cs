...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlDivElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlDivElementWrapper : Wrapper<IHtmlDivElement>, IHtmlDivElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlDivElementWrapper"/> type;
        /// </summary>
        public HtmlDivElementWrapper(IElementFactory<IHtmlDivElement> elementFactory) : base(elementFactory) { }
