...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlDataElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlDataElementWrapper : Wrapper<IHtmlDataElement>, IHtmlDataElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlDataElementWrapper"/> type;
        /// </summary>
        public HtmlDataElementWrapper(IElementFactory<IHtmlDataElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
