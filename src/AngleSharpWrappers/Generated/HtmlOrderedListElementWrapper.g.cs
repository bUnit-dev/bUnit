...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlOrderedListElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlOrderedListElementWrapper : Wrapper<IHtmlOrderedListElement>, IHtmlOrderedListElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlOrderedListElementWrapper"/> type;
        /// </summary>
        public HtmlOrderedListElementWrapper(IElementFactory<IHtmlOrderedListElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean IsReversed { get => WrappedElement.IsReversed; set => WrappedElement.IsReversed = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32 Start { get => WrappedElement.Start; set => WrappedElement.Start = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
