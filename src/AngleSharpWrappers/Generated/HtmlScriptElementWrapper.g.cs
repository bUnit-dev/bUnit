...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlScriptElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlScriptElementWrapper : Wrapper<IHtmlScriptElement>, IHtmlScriptElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlScriptElementWrapper"/> type;
        /// </summary>
        public HtmlScriptElementWrapper(IElementFactory<IHtmlScriptElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? CharacterSet { get => WrappedElement.CharacterSet; set => WrappedElement.CharacterSet = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean IsAsync { get => WrappedElement.IsAsync; set => WrappedElement.IsAsync = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean IsContentEditable { get => WrappedElement.IsContentEditable; }
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean IsDeferred { get => WrappedElement.IsDeferred; set => WrappedElement.IsDeferred = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public String Text { get => WrappedElement.Text; set => WrappedElement.Text = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
