...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlOutputElementWrapper : Wrapper<IHtmlOutputElement>, IHtmlOutputElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlOutputElementWrapper"/> type;
        /// </summary>
        public HtmlOutputElementWrapper(IElementFactory<IHtmlOutputElement> elementFactory) : base(elementFactory) { }
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public ISettableTokenList HtmlFor { get => WrappedElement.HtmlFor; }
        /// <inheritdoc/>
        [DebuggerHidden]
