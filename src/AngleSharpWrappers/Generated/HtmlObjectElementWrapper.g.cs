...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlObjectElementWrapper : Wrapper<IHtmlObjectElement>, IHtmlObjectElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlObjectElementWrapper"/> type;
        /// </summary>
        public HtmlObjectElementWrapper(IElementFactory<IHtmlObjectElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean TypeMustMatch { get => WrappedElement.TypeMustMatch; set => WrappedElement.TypeMustMatch = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
