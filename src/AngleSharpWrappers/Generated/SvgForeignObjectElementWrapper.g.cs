...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="ISvgForeignObjectElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class SvgForeignObjectElementWrapper : Wrapper<ISvgForeignObjectElement>, ISvgForeignObjectElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="SvgForeignObjectElementWrapper"/> type;
        /// </summary>
        public SvgForeignObjectElementWrapper(IElementFactory<ISvgForeignObjectElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
