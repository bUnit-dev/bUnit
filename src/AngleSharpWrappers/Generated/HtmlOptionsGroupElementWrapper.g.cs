...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlOptionsGroupElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlOptionsGroupElementWrapper : Wrapper<IHtmlOptionsGroupElement>, IHtmlOptionsGroupElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlOptionsGroupElementWrapper"/> type;
        /// </summary>
        public HtmlOptionsGroupElementWrapper(IElementFactory<IHtmlOptionsGroupElement> elementFactory) : base(elementFactory) { }
