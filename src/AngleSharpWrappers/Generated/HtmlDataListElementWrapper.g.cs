...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlDataListElementWrapper : Wrapper<IHtmlDataListElement>, IHtmlDataListElement
    {
        ...
        /// </summary>
        public HtmlDataListElementWrapper(IElementFactory<IHtmlDataListElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public IHtmlCollection<IHtmlOptionElement> Options { get => WrappedElement.Options; }
        /// <inheritdoc/>
        [DebuggerHidden]
