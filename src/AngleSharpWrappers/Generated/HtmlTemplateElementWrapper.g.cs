...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlTemplateElementWrapper : Wrapper<IHtmlTemplateElement>, IHtmlTemplateElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTemplateElementWrapper"/> type;
        /// </summary>
        public HtmlTemplateElementWrapper(IElementFactory<IHtmlTemplateElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public IDocumentFragment Content { get => WrappedElement.Content; }
        /// <inheritdoc/>
        [DebuggerHidden]
