...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlDialogElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlDialogElementWrapper : Wrapper<IHtmlDialogElement>, IHtmlDialogElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlDialogElementWrapper"/> type;
        /// </summary>
        public HtmlDialogElementWrapper(IElementFactory<IHtmlDialogElement> elementFactory) : base(elementFactory) { }
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean Open { get => WrappedElement.Open; set => WrappedElement.Open = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? ReturnValue { get => WrappedElement.ReturnValue; set => WrappedElement.ReturnValue = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public void Show(IElement? anchor) => WrappedElement.Show(anchor);
        /// <inheritdoc/>
        [DebuggerHidden]
        public void ShowModal(IElement? anchor) => WrappedElement.ShowModal(anchor);
        /// <inheritdoc/>
        [DebuggerHidden]
