...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlEmbedElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlEmbedElementWrapper : Wrapper<IHtmlEmbedElement>, IHtmlEmbedElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlEmbedElementWrapper"/> type;
        /// </summary>
        public HtmlEmbedElementWrapper(IElementFactory<IHtmlEmbedElement> elementFactory) : base(elementFactory) { }
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? DisplayHeight { get => WrappedElement.DisplayHeight; set => WrappedElement.DisplayHeight = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? DisplayWidth { get => WrappedElement.DisplayWidth; set => WrappedElement.DisplayWidth = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
