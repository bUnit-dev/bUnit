...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlSlotElementWrapper : Wrapper<IHtmlSlotElement>, IHtmlSlotElement
    {
        ...
        /// </summary>
        public HtmlSlotElementWrapper(IElementFactory<IHtmlSlotElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public IEnumerable<INode> GetDistributedNodes() => WrappedElement.GetDistributedNodes();
        /// <inheritdoc/>
        [DebuggerHidden]
