...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlHeadingElement"/> type.
    /// </summary>
    [DebuggerDisplay("{OuterHtml,nq}")]
    public sealed class HtmlHeadingElementWrapper : Wrapper<IHtmlHeadingElement>, IHtmlHeadingElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlHeadingElementWrapper"/> type;
        /// </summary>
        public HtmlHeadingElementWrapper(IElementFactory<IHtmlHeadingElement> elementFactory) : base(elementFactory) { }
