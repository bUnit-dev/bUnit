...
namespace AngleSharpWrappers
{
    ...
    public sealed class SvgCircleElementWrapper : Wrapper<ISvgCircleElement>, ISvgCircleElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="SvgCircleElementWrapper"/> type;
        /// </summary>
        public SvgCircleElementWrapper(IElementFactory<ISvgCircleElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
