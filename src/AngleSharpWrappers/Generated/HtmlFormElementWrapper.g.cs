...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlFormElementWrapper : Wrapper<IHtmlFormElement>, IHtmlFormElement
    {
        ...
        /// </summary>
        public HtmlFormElementWrapper(IElementFactory<IHtmlFormElement> elementFactory) : base(elementFactory) { }
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public IElement? this[Int32 index] { get => WrappedElement[index]; }

        /// <inheritdoc/>
        [DebuggerHidden]
        public IElement? this[String name] { get => WrappedElement[name]; }
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? AcceptCharset { get => WrappedElement.AcceptCharset; set => WrappedElement.AcceptCharset = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public String Action { get => WrappedElement.Action; set => WrappedElement.Action = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public IHtmlFormControlsCollection Elements { get => WrappedElement.Elements; }
        /// <inheritdoc/>
        [DebuggerHidden]
        public String Encoding { get => WrappedElement.Encoding; set => WrappedElement.Encoding = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        public String? Enctype { get => WrappedElement.Enctype; set => WrappedElement.Enctype = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Int32 Length { get => WrappedElement.Length; }
        /// <inheritdoc/>
        [DebuggerHidden]
        public String LocalName { get => WrappedElement.LocalName; }
        /// <inheritdoc/>
        [DebuggerHidden]
        public String Method { get => WrappedElement.Method; set => WrappedElement.Method = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean NoValidate { get => WrappedElement.NoValidate; set => WrappedElement.NoValidate = value;}
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public DocumentRequest? GetSubmission() => WrappedElement.GetSubmission();
        /// <inheritdoc/>
        [DebuggerHidden]
        public DocumentRequest? GetSubmission(IHtmlElement sourceElement) => WrappedElement.GetSubmission(sourceElement);
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Boolean ReportValidity() => WrappedElement.ReportValidity();
        /// <inheritdoc/>
        [DebuggerHidden]
        ...
        /// <inheritdoc/>
        [DebuggerHidden]
        public Task<IDocument> SubmitAsync() => WrappedElement.SubmitAsync();
        /// <inheritdoc/>
        [DebuggerHidden]
        public Task<IDocument> SubmitAsync(IHtmlElement sourceElement) => WrappedElement.SubmitAsync(sourceElement);
        /// <inheritdoc/>
        [DebuggerHidden]
