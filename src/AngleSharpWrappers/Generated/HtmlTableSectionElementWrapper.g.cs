...
namespace AngleSharpWrappers
{
    ...
    public sealed class HtmlTableSectionElementWrapper : Wrapper<IHtmlTableSectionElement>, IHtmlTableSectionElement
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTableSectionElementWrapper"/> type;
        /// </summary>
        public HtmlTableSectionElementWrapper(IElementFactory<IHtmlTableSectionElement> elementFactory) : base(elementFactory) { }
/// <inheritdoc/>
