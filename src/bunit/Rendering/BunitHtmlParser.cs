...
public sealed class BunitHtmlParser : IDisposable
{
	...
	/// </summary>
	public BunitHtmlParser(HtmlComparer htmlComparer, BunitContext bunitContext)
		: this(Configuration.Default.WithCss()
			  .With(htmlComparer ?? throw new ArgumentNullException(nameof(htmlComparer)))
			  .With(bunitContext ?? throw new ArgumentNullException(nameof(bunitContext)))
			  .With(bunitContext.Renderer))
	{ }
