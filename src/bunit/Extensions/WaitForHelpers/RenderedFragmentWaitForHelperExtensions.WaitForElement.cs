...
public static partial class RenderedFragmentWaitForHelperExtensions
{
	...
	public static IElement WaitForElement<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector)
		where TComponent : IComponent => WaitForElementCore(renderedFragment, cssSelector, timeout: null);
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout. See the inner exception for details.</exception>
	/// <returns>The <see cref="IElement"/>.</returns>
	public static IElement WaitForElement<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector, TimeSpan timeout)
	...
	public static IRefreshableElementCollection<IElement> WaitForElements<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector)
		where TComponent : IComponent => WaitForElementsCore(renderedFragment, cssSelector, matchElementCount: null, timeout: null);
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout.</exception>
	/// <returns>The <see cref="IRefreshableElementCollection{IElement}"/>.</returns>
	public static IRefreshableElementCollection<IElement> WaitForElements<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector, int matchElementCount)
		where TComponent : IComponent => WaitForElementsCore(renderedFragment, cssSelector, matchElementCount: matchElementCount, timeout: null);
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout.</exception>
	/// <returns>The <see cref="IRefreshableElementCollection{IElement}"/>.</returns>
	public static IRefreshableElementCollection<IElement> WaitForElements<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector, TimeSpan timeout)
		where TComponent : IComponent
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout.</exception>
	/// <returns>The <see cref="IRefreshableElementCollection{IElement}"/>.</returns>
	public static IRefreshableElementCollection<IElement> WaitForElements<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector, int matchElementCount, TimeSpan timeout)
		where TComponent : IComponent
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout. See the inner exception for details.</exception>
	/// <returns>The <see cref="IElement"/>.</returns>
	internal static Task<IElement> WaitForElementAsync<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector)
		where TComponent : IComponent => WaitForElementCoreAsync(renderedFragment, cssSelector, timeout: null);
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout. See the inner exception for details.</exception>
	/// <returns>The <see cref="IElement"/>.</returns>
	internal static Task<IElement> WaitForElementAsync<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector, TimeSpan timeout)
		where TComponent : IComponent
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout.</exception>
	/// <returns>The <see cref="IRefreshableElementCollection{IElement}"/>.</returns>
	internal static Task<IRefreshableElementCollection<IElement>> WaitForElementsAsync<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector, int matchElementCount)
		where TComponent : IComponent
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout.</exception>
	/// <returns>The <see cref="IRefreshableElementCollection{IElement}"/>.</returns>
	internal static Task<IRefreshableElementCollection<IElement>> WaitForElementsAsync<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector, TimeSpan timeout)
		where TComponent : IComponent
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout.</exception>
	/// <returns>The <see cref="IRefreshableElementCollection{IElement}"/>.</returns>
	internal static Task<IRefreshableElementCollection<IElement>> WaitForElementsAsync<TComponent>(this IRenderedComponent<TComponent> renderedFragment, string cssSelector, int matchElementCount, TimeSpan timeout)
		where TComponent : IComponent
	...
	private static IRefreshableElementCollection<IElement> WaitForElementsCore<TComponent>(
		this IRenderedComponent<TComponent> renderedFragment,
		string cssSelector,
		int? matchElementCount,
		TimeSpan? timeout)
		where TComponent : IComponent
	{
		using var waiter = new WaitForElementsHelper<TComponent>(renderedFragment, cssSelector, matchElementCount, timeout);
