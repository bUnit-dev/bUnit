...
public static class RenderedFragmentWaitForHelperExtensions
{
	...
	public static async Task WaitForStateAsync(this RenderedFragment renderedFragment, Func<bool> statePredicate, TimeSpan? timeout = null)
	{
	...
	[AssertionMethod]
	public static async Task WaitForAssertionAsync(this RenderedFragment renderedFragment, Action assertion, TimeSpan? timeout = null)
	{
	...
	public static Task<IElement> WaitForElementAsync(this RenderedFragment renderedFragment, string cssSelector)
	...
	/// <exception cref="WaitForFailedException">Thrown if no elements is found matching the <paramref name="cssSelector"/> within the default timeout.</exception>
	/// <returns>The <see cref="IRefreshableElementCollection{IElement}"/>.</returns>
	public static Task<IRefreshableElementCollection<IElement>> WaitForElementsAsync(this RenderedFragment renderedFragment, string cssSelector)
