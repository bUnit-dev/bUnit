...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlMenuItemElement"/> type.
    /// </summary>
    public partial class HtmlMenuItemElementWrapper : Wrapper<IHtmlMenuItemElement>, IHtmlMenuItemElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlMenuItemElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlMenuItemElementWrapper(Func<IHtmlMenuItemElement?> getObject) : base(getObject) { }
        ...
        private static readonly int CommandKey = HashCode.Combine(nameof(Command));
        /// <inheritdoc/>
        public IHtmlElement Command { get => GetOrWrap(CommandKey, () => WrappedObject.Command); }
        ...
        /// <inheritdoc/>
        public String Icon { get => WrappedObject.Icon; set => WrappedObject.Icon = value;}
        ...
        /// <inheritdoc/>
        public Boolean IsDefault { get => WrappedObject.IsDefault; set => WrappedObject.IsDefault = value;}
        ...
        /// <inheritdoc/>
        public String RadioGroup { get => WrappedObject.RadioGroup; set => WrappedObject.RadioGroup = value;}
