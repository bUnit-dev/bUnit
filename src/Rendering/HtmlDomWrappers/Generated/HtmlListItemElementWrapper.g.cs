...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlListItemElementWrapper : Wrapper<IHtmlListItemElement>, IHtmlListItemElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlListItemElementWrapper(Func<IHtmlListItemElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public Nullable<Int32> Value { get => WrappedObject.Value; set => WrappedObject.Value = value;}
