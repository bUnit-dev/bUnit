...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlMediaElementWrapper : Wrapper<IHtmlMediaElement>, IHtmlMediaElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlMediaElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlMediaElementWrapper(Func<IHtmlMediaElement?> getObject) : base(getObject) { }
