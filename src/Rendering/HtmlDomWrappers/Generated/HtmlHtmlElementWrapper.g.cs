...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlHtmlElementWrapper : Wrapper<IHtmlHtmlElement>, IHtmlHtmlElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlHtmlElementWrapper(Func<IHtmlHtmlElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public String Manifest { get => WrappedObject.Manifest; set => WrappedObject.Manifest = value;}
