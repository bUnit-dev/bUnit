...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlSlotElementWrapper : Wrapper<IHtmlSlotElement>, IHtmlSlotElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlSlotElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlSlotElementWrapper(Func<IHtmlSlotElement?> getObject) : base(getObject) { }
        ...
        public IEnumerable<INode> GetDistributedNodes()
            => WrappedObject.GetDistributedNodes();
