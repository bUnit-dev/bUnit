...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTableRowElement"/> type.
    /// </summary>
    public partial class HtmlTableRowElementWrapper : Wrapper<IHtmlTableRowElement>, IHtmlTableRowElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTableRowElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlTableRowElementWrapper(Func<IHtmlTableRowElement?> getObject) : base(getObject) { }
        ...
        private static readonly int CellsKey = HashCode.Combine(nameof(Cells));
        /// <inheritdoc/>
        public IHtmlCollection<IHtmlTableCellElement> Cells { get => GetOrWrap(CellsKey, () => WrappedObject.Cells); }
        ...
        /// <inheritdoc/>
        public Int32 IndexInSection { get => WrappedObject.IndexInSection; }
        ...
        /// <inheritdoc/>
        public IHtmlTableCellElement InsertCellAt(Int32 index, TableCellKind tableCellKind)
            => GetOrWrap(HashCode.Combine(nameof(InsertCellAt), index, tableCellKind), () => WrappedObject.InsertCellAt(index, tableCellKind));
        ...
        public void RemoveCellAt(Int32 index)
            => WrappedObject.RemoveCellAt(index);
