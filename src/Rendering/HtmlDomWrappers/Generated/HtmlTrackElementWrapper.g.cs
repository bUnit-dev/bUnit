...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlTrackElementWrapper : Wrapper<IHtmlTrackElement>, IHtmlTrackElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTrackElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlTrackElementWrapper(Func<IHtmlTrackElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public String Kind { get => WrappedObject.Kind; set => WrappedObject.Kind = value;}
        ...
        /// <inheritdoc/>
        public TrackReadyState ReadyState { get => WrappedObject.ReadyState; }
        ...
        /// <inheritdoc/>
        public String SourceLanguage { get => WrappedObject.SourceLanguage; set => WrappedObject.SourceLanguage = value;}
        ...
        /// <inheritdoc/>
        public ITextTrack Track { get => WrappedObject.Track; }
