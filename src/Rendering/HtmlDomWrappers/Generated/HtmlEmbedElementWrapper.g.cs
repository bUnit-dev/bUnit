...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlEmbedElementWrapper : Wrapper<IHtmlEmbedElement>, IHtmlEmbedElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlEmbedElementWrapper(Func<IHtmlEmbedElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public String DisplayHeight { get => WrappedObject.DisplayHeight; set => WrappedObject.DisplayHeight = value;}

        /// <inheritdoc/>
        public String DisplayWidth { get => WrappedObject.DisplayWidth; set => WrappedObject.DisplayWidth = value;}
