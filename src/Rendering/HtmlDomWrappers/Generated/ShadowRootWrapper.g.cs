...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    public partial class ShadowRootWrapper : Wrapper<IShadowRoot>, IShadowRoot, IWrapper
    {
        ...
        public ShadowRootWrapper(Func<IShadowRoot?> getObject) : base(getObject) { }
        ...
        private static readonly int HostKey = HashCode.Combine(nameof(Host));
        /// <inheritdoc/>
        public IElement Host { get => GetOrWrap(HostKey, () => WrappedObject.Host); }
