...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTableSectionElement"/> type.
    /// </summary>
    public partial class HtmlTableSectionElementWrapper : Wrapper<IHtmlTableSectionElement>, IHtmlTableSectionElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTableSectionElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlTableSectionElementWrapper(Func<IHtmlTableSectionElement?> getObject) : base(getObject) { }
