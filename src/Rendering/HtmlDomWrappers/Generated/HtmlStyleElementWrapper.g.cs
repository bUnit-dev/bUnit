...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlStyleElement"/> type.
    /// </summary>
    public partial class HtmlStyleElementWrapper : Wrapper<IHtmlStyleElement>, IHtmlStyleElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlStyleElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlStyleElementWrapper(Func<IHtmlStyleElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public Boolean IsScoped { get => WrappedObject.IsScoped; set => WrappedObject.IsScoped = value;}
