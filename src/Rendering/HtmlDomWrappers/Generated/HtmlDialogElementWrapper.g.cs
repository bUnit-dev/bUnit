...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlDialogElementWrapper : Wrapper<IHtmlDialogElement>, IHtmlDialogElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlDialogElementWrapper(Func<IHtmlDialogElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public Boolean Open { get => WrappedObject.Open; set => WrappedObject.Open = value;}
        ...
        /// <inheritdoc/>
        public String ReturnValue { get => WrappedObject.ReturnValue; set => WrappedObject.ReturnValue = value;}
        ...
        public void Close(String returnValue)
            => WrappedObject.Close(returnValue);
        ...
        public void Show(IElement anchor)
            => WrappedObject.Show(anchor);

        /// <inheritdoc/>
        public void ShowModal(IElement anchor)
            => WrappedObject.ShowModal(anchor);
