...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTableElement"/> type.
    /// </summary>
    public partial class HtmlTableElementWrapper : Wrapper<IHtmlTableElement>, IHtmlTableElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlTableElementWrapper(Func<IHtmlTableElement?> getObject) : base(getObject) { }
        ...
        private static readonly int BodiesKey = HashCode.Combine(nameof(Bodies));
        /// <inheritdoc/>
        public IHtmlCollection<IHtmlTableSectionElement> Bodies { get => GetOrWrap(BodiesKey, () => WrappedObject.Bodies); }

        /// <inheritdoc/>
        public UInt32 Border { get => WrappedObject.Border; set => WrappedObject.Border = value;}

        private static readonly int CaptionKey = HashCode.Combine(nameof(Caption));
        /// <inheritdoc/>
        public IHtmlTableCaptionElement Caption { get => GetOrWrap(CaptionKey, () => WrappedObject.Caption); set { WrappedObject.Caption = value; MarkAsStale(); }}
        ...
        private static readonly int FootKey = HashCode.Combine(nameof(Foot));
        /// <inheritdoc/>
        public IHtmlTableSectionElement Foot { get => GetOrWrap(FootKey, () => WrappedObject.Foot); set { WrappedObject.Foot = value; MarkAsStale(); }}
        ...
        /// <inheritdoc/>
        public IHtmlTableSectionElement Head { get => GetOrWrap(HeadKey, () => WrappedObject.Head); set { WrappedObject.Head = value; MarkAsStale(); }}
        ...
        private static readonly int RowsKey = HashCode.Combine(nameof(Rows));
        /// <inheritdoc/>
        public IHtmlCollection<IHtmlTableRowElement> Rows { get => GetOrWrap(RowsKey, () => WrappedObject.Rows); }
        ...
        private static readonly int CreateBodyKey = HashCode.Combine(nameof(CreateBody));
        /// <inheritdoc/>
        public IHtmlTableSectionElement CreateBody()
            => GetOrWrap(CreateBodyKey, () => WrappedObject.CreateBody());

        private static readonly int CreateCaptionKey = HashCode.Combine(nameof(CreateCaption));
        /// <inheritdoc/>
        public IHtmlTableCaptionElement CreateCaption()
            => GetOrWrap(CreateCaptionKey, () => WrappedObject.CreateCaption());

        private static readonly int CreateFootKey = HashCode.Combine(nameof(CreateFoot));
        /// <inheritdoc/>
        public IHtmlTableSectionElement CreateFoot()
            => GetOrWrap(CreateFootKey, () => WrappedObject.CreateFoot());

        private static readonly int CreateHeadKey = HashCode.Combine(nameof(CreateHead));
        /// <inheritdoc/>
        public IHtmlTableSectionElement CreateHead()
            => GetOrWrap(CreateHeadKey, () => WrappedObject.CreateHead());

        /// <inheritdoc/>
        public void DeleteCaption()
            => WrappedObject.DeleteCaption();

        /// <inheritdoc/>
        public void DeleteFoot()
            => WrappedObject.DeleteFoot();

        /// <inheritdoc/>
        public void DeleteHead()
            => WrappedObject.DeleteHead();
        ...
        /// <inheritdoc/>
        public IHtmlTableRowElement InsertRowAt(Int32 index)
            => GetOrWrap(HashCode.Combine(nameof(InsertRowAt), index), () => WrappedObject.InsertRowAt(index));
        ...
        public void RemoveRowAt(Int32 index)
            => WrappedObject.RemoveRowAt(index);
