...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlCanvasElementWrapper : Wrapper<IHtmlCanvasElement>, IHtmlCanvasElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlCanvasElementWrapper(Func<IHtmlCanvasElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public Int32 Height { get => WrappedObject.Height; set => WrappedObject.Height = value;}
        ...
        /// <inheritdoc/>
        public Int32 Width { get => WrappedObject.Width; set => WrappedObject.Width = value;}
        ...
        public IRenderingContext GetContext(String contextId)
            => WrappedObject.GetContext(contextId);
        ...
        public Boolean IsSupportingContext(String contextId)
            => WrappedObject.IsSupportingContext(contextId);
        ...
        public void SetContext(IRenderingContext context)
            => WrappedObject.SetContext(context);

        /// <inheritdoc/>
        public void ToBlob(Action<Stream> callback, String type)
            => WrappedObject.ToBlob(callback, type);

        /// <inheritdoc/>
        public String ToDataUrl(String type)
            => WrappedObject.ToDataUrl(type);
