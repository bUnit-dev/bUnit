...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlAudioElementWrapper : Wrapper<IHtmlAudioElement>, IHtmlAudioElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlAudioElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlAudioElementWrapper(Func<IHtmlAudioElement?> getObject) : base(getObject) { }
        ...
        private static readonly int AudioTracksKey = HashCode.Combine(nameof(AudioTracks));
        /// <inheritdoc/>
        public IAudioTrackList AudioTracks { get => GetOrWrap(AudioTracksKey, () => WrappedObject.AudioTracks); }
        ...
        private static readonly int TextTracksKey = HashCode.Combine(nameof(TextTracks));
        /// <inheritdoc/>
        public ITextTrackList TextTracks { get => GetOrWrap(TextTracksKey, () => WrappedObject.TextTracks); }

        /// <inheritdoc/>
        public String Title { get => WrappedObject.Title; set => WrappedObject.Title = value;}

        private static readonly int VideoTracksKey = HashCode.Combine(nameof(VideoTracks));
        /// <inheritdoc/>
        public IVideoTrackList VideoTracks { get => GetOrWrap(VideoTracksKey, () => WrappedObject.VideoTracks); }
        ...
        /// <inheritdoc/>
        public ITextTrack AddTextTrack(String kind, String label, String language)
            => WrappedObject.AddTextTrack(kind, label, language);
        ...
        public String CanPlayType(String type)
            => WrappedObject.CanPlayType(type);
