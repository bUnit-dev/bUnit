...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlLabelElement"/> type.
    /// </summary>
    public partial class HtmlLabelElementWrapper : Wrapper<IHtmlLabelElement>, IHtmlLabelElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlLabelElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlLabelElementWrapper(Func<IHtmlLabelElement?> getObject) : base(getObject) { }
        ...
        private static readonly int ControlKey = HashCode.Combine(nameof(Control));
        /// <inheritdoc/>
        public IHtmlElement Control { get => GetOrWrap(ControlKey, () => WrappedObject.Control); }
        ...
        /// <inheritdoc/>
        public String HtmlFor { get => WrappedObject.HtmlFor; set => WrappedObject.HtmlFor = value;}
