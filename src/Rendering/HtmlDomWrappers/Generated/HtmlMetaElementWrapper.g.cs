...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlMetaElementWrapper : Wrapper<IHtmlMetaElement>, IHtmlMetaElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlMetaElementWrapper(Func<IHtmlMetaElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public String Charset { get => WrappedObject.Charset; set => WrappedObject.Charset = value;}
        ...
        /// <inheritdoc/>
        public String Content { get => WrappedObject.Content; set => WrappedObject.Content = value;}
        ...
        /// <inheritdoc/>
        public String HttpEquivalent { get => WrappedObject.HttpEquivalent; set => WrappedObject.HttpEquivalent = value;}
