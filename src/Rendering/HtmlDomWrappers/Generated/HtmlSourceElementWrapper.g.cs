...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlSourceElementWrapper : Wrapper<IHtmlSourceElement>, IHtmlSourceElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlSourceElementWrapper(Func<IHtmlSourceElement?> getObject) : base(getObject) { }
