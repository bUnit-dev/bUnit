...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    /// </summary>
    public partial class HtmlBreakRowElementWrapper : Wrapper<IHtmlBreakRowElement>, IHtmlBreakRowElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlBreakRowElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlBreakRowElementWrapper(Func<IHtmlBreakRowElement?> getObject) : base(getObject) { }
