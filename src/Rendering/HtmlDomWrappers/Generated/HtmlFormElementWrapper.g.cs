...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    ...
    public partial class HtmlFormElementWrapper : Wrapper<IHtmlFormElement>, IHtmlFormElement, IWrapper
    {
        ...
        public HtmlFormElementWrapper(Func<IHtmlFormElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public IElement this[String name] { get => GetOrWrap(HashCode.Combine("this+System.String", name), () => WrappedObject[name]); }
