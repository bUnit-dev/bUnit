...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlSelectElement"/> type.
    /// </summary>
    public partial class HtmlSelectElementWrapper : Wrapper<IHtmlSelectElement>, IHtmlSelectElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlSelectElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlSelectElementWrapper(Func<IHtmlSelectElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public IHtmlOptionElement this[Int32 index] { get => GetOrWrap(HashCode.Combine("this+System.Int32", index), () => WrappedObject[index]); set { WrappedObject[index] = value; MarkAsStale(); }}
        ...
        private static readonly int FormKey = HashCode.Combine(nameof(Form));
        /// <inheritdoc/>
        public IHtmlFormElement Form { get => GetOrWrap(FormKey, () => WrappedObject.Form); }
        ...
        private static readonly int LabelsKey = HashCode.Combine(nameof(Labels));
        /// <inheritdoc/>
        public INodeList Labels { get => GetOrWrap(LabelsKey, () => WrappedObject.Labels); }
        ...
        private static readonly int OptionsKey = HashCode.Combine(nameof(Options));
        /// <inheritdoc/>
        public IHtmlOptionsCollection Options { get => GetOrWrap(OptionsKey, () => WrappedObject.Options); }
        ...
        private static readonly int SelectedOptionsKey = HashCode.Combine(nameof(SelectedOptions));
        /// <inheritdoc/>
        public IHtmlCollection<IHtmlOptionElement> SelectedOptions { get => GetOrWrap(SelectedOptionsKey, () => WrappedObject.SelectedOptions); }
        ...
        /// <inheritdoc/>
        public void AddOption(IHtmlOptionElement element, IHtmlElement before)
        {
            WrappedObject.AddOption(element, before);
            MarkAsStale();
        }

        /// <inheritdoc/>
        public void AddOption(IHtmlOptionsGroupElement element, IHtmlElement before)
        {
            WrappedObject.AddOption(element, before);
            MarkAsStale();
        }
        ...
        public void RemoveOptionAt(Int32 index)
            => WrappedObject.RemoveOptionAt(index);
