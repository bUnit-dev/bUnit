...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlFieldSetElement"/> type.
    /// </summary>
    public partial class HtmlFieldSetElementWrapper : Wrapper<IHtmlFieldSetElement>, IHtmlFieldSetElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlFieldSetElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlFieldSetElementWrapper(Func<IHtmlFieldSetElement?> getObject) : base(getObject) { }
        ...
        private static readonly int ElementsKey = HashCode.Combine(nameof(Elements));
        /// <inheritdoc/>
        public IHtmlFormControlsCollection Elements { get => GetOrWrap(ElementsKey, () => WrappedObject.Elements); }
