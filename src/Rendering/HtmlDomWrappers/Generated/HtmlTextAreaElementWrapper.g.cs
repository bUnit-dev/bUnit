...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTextAreaElement"/> type.
    /// </summary>
    public partial class HtmlTextAreaElementWrapper : Wrapper<IHtmlTextAreaElement>, IHtmlTextAreaElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTextAreaElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlTextAreaElementWrapper(Func<IHtmlTextAreaElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public Int32 Columns { get => WrappedObject.Columns; set => WrappedObject.Columns = value;}
        ...
        /// <inheritdoc/>
        public Int32 Rows { get => WrappedObject.Rows; set => WrappedObject.Rows = value;}
        ...
        /// <inheritdoc/>
        public Int32 TextLength { get => WrappedObject.TextLength; }
        ...
        /// <inheritdoc/>
        public String Wrap { get => WrappedObject.Wrap; set => WrappedObject.Wrap = value;}
