...
namespace Egil.RazorComponents.Testing.Rendering.HtmlDomWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlAnchorElement"/> type.
    /// </summary>
    public partial class HtmlAnchorElementWrapper : Wrapper<IHtmlAnchorElement>, IHtmlAnchorElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlAnchorElementWrapper(Func<IHtmlAnchorElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public String Type { get => WrappedObject.Type; }
