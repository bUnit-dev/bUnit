...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    public partial class HtmlMenuElementWrapper : Wrapper<IHtmlMenuElement>, IHtmlMenuElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlMenuElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlMenuElementWrapper(Func<IHtmlMenuElement?> getObject) : base(getObject) { }
