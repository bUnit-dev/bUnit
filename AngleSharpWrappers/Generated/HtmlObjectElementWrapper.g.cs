...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlObjectElement"/> type.
    /// </summary>
    public partial class HtmlObjectElementWrapper : Wrapper<IHtmlObjectElement>, IHtmlObjectElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlObjectElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlObjectElementWrapper(Func<IHtmlObjectElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public Boolean TypeMustMatch { get => WrappedObject.TypeMustMatch; set => WrappedObject.TypeMustMatch = value;}

        /// <inheritdoc/>
        public String UseMap { get => WrappedObject.UseMap; set => WrappedObject.UseMap = value;}
