...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlKeygenElement"/> type.
    /// </summary>
    public partial class HtmlKeygenElementWrapper : Wrapper<IHtmlKeygenElement>, IHtmlKeygenElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlKeygenElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlKeygenElementWrapper(Func<IHtmlKeygenElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public String Challenge { get => WrappedObject.Challenge; set => WrappedObject.Challenge = value;}
        ...
        /// <inheritdoc/>
        public String KeyEncryption { get => WrappedObject.KeyEncryption; set => WrappedObject.KeyEncryption = value;}
