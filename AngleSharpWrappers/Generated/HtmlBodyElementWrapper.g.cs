...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    public partial class HtmlBodyElementWrapper : Wrapper<IHtmlBodyElement>, IHtmlBodyElement, IWrapper
    {
        /// <summary>
        ...
        public HtmlBodyElementWrapper(Func<IHtmlBodyElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public event DomEventHandler HashChanged { add => WrappedObject.HashChanged += value; remove => WrappedObject.HashChanged -= value; }
        ...
        /// <inheritdoc/>
        public event DomEventHandler MessageReceived { add => WrappedObject.MessageReceived += value; remove => WrappedObject.MessageReceived -= value; }
        ...
        /// <inheritdoc/>
        public event DomEventHandler PageHidden { add => WrappedObject.PageHidden += value; remove => WrappedObject.PageHidden -= value; }

        /// <inheritdoc/>
        public event DomEventHandler PageShown { add => WrappedObject.PageShown += value; remove => WrappedObject.PageShown -= value; }
        ...
        /// <inheritdoc/>
        public event DomEventHandler PopState { add => WrappedObject.PopState += value; remove => WrappedObject.PopState -= value; }

        /// <inheritdoc/>
        public event DomEventHandler Printed { add => WrappedObject.Printed += value; remove => WrappedObject.Printed -= value; }

        /// <inheritdoc/>
        public event DomEventHandler Printing { add => WrappedObject.Printing += value; remove => WrappedObject.Printing -= value; }
        ...
        /// <inheritdoc/>
        public event DomEventHandler Storage { add => WrappedObject.Storage += value; remove => WrappedObject.Storage -= value; }
        ...
        /// <inheritdoc/>
        public event DomEventHandler Unloaded { add => WrappedObject.Unloaded += value; remove => WrappedObject.Unloaded -= value; }

        /// <inheritdoc/>
        public event DomEventHandler Unloading { add => WrappedObject.Unloading += value; remove => WrappedObject.Unloading -= value; }
        ...
        /// <inheritdoc/>
        public event DomEventHandler WentOffline { add => WrappedObject.WentOffline += value; remove => WrappedObject.WentOffline -= value; }

        /// <inheritdoc/>
        public event DomEventHandler WentOnline { add => WrappedObject.WentOnline += value; remove => WrappedObject.WentOnline -= value; }
