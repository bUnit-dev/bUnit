...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlCommandElement"/> type.
    /// </summary>
    public partial class HtmlCommandElementWrapper : Wrapper<IHtmlCommandElement>, IHtmlCommandElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlCommandElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlCommandElementWrapper(Func<IHtmlCommandElement?> getObject) : base(getObject) { }
