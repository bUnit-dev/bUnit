...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlMeterElement"/> type.
    /// </summary>
    public partial class HtmlMeterElementWrapper : Wrapper<IHtmlMeterElement>, IHtmlMeterElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlMeterElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlMeterElementWrapper(Func<IHtmlMeterElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public Double High { get => WrappedObject.High; set => WrappedObject.High = value;}
        ...
        /// <inheritdoc/>
        public Double Low { get => WrappedObject.Low; set => WrappedObject.Low = value;}

        /// <inheritdoc/>
        public Double Maximum { get => WrappedObject.Maximum; set => WrappedObject.Maximum = value;}

        /// <inheritdoc/>
        public Double Minimum { get => WrappedObject.Minimum; set => WrappedObject.Minimum = value;}
        ...
        /// <inheritdoc/>
        public Double Optimum { get => WrappedObject.Optimum; set => WrappedObject.Optimum = value;}
        ...
        /// <inheritdoc/>
        public Double Value { get => WrappedObject.Value; set => WrappedObject.Value = value;}
