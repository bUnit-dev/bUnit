...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    public partial class HtmlDataListElementWrapper : Wrapper<IHtmlDataListElement>, IHtmlDataListElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlDataListElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlDataListElementWrapper(Func<IHtmlDataListElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public IHtmlCollection<IHtmlOptionElement> Options { get => GetOrWrap(OptionsKey, () => WrappedObject.Options); }
