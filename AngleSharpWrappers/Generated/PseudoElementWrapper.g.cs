...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    public partial class PseudoElementWrapper : Wrapper<IPseudoElement>, IPseudoElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="PseudoElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public PseudoElementWrapper(Func<IPseudoElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public String PseudoName { get => WrappedObject.PseudoName; }
