...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlOutputElement"/> type.
    /// </summary>
    public partial class HtmlOutputElementWrapper : Wrapper<IHtmlOutputElement>, IHtmlOutputElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlOutputElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlOutputElementWrapper(Func<IHtmlOutputElement?> getObject) : base(getObject) { }
        ...
        private static readonly int HtmlForKey = HashCode.Combine(nameof(HtmlFor));
        /// <inheritdoc/>
        public ISettableTokenList HtmlFor { get => GetOrWrap(HtmlForKey, () => WrappedObject.HtmlFor); }
