...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTableCellElement"/> type.
    /// </summary>
    public partial class HtmlTableCellElementWrapper : Wrapper<IHtmlTableCellElement>, IHtmlTableCellElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTableCellElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlTableCellElementWrapper(Func<IHtmlTableCellElement?> getObject) : base(getObject) { }
