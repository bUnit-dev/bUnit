...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlButtonElement"/> type.
    /// </summary>
    public partial class HtmlButtonElementWrapper : Wrapper<IHtmlButtonElement>, IHtmlButtonElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlButtonElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlButtonElementWrapper(Func<IHtmlButtonElement?> getObject) : base(getObject) { }
