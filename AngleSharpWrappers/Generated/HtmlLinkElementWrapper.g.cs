...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlLinkElement"/> type.
    /// </summary>
    public partial class HtmlLinkElementWrapper : Wrapper<IHtmlLinkElement>, IHtmlLinkElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlLinkElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlLinkElementWrapper(Func<IHtmlLinkElement?> getObject) : base(getObject) { }
        ...
        private static readonly int ImportKey = HashCode.Combine(nameof(Import));
        /// <inheritdoc/>
        public IDocument Import { get => GetOrWrap(ImportKey, () => WrappedObject.Import); }

        /// <inheritdoc/>
        public String InnerHtml { get => WrappedObject.InnerHtml; set => WrappedObject.InnerHtml = value;}

        /// <inheritdoc/>
        public String Integrity { get => WrappedObject.Integrity; set => WrappedObject.Integrity = value;}
        ...
        /// <inheritdoc/>
        public String Media { get => WrappedObject.Media; set => WrappedObject.Media = value;}
        ...
        /// <inheritdoc/>
        public String NumberUsedOnce { get => WrappedObject.NumberUsedOnce; set => WrappedObject.NumberUsedOnce = value;}
        ...
        /// <inheritdoc/>
        public String ReverseRelation { get => WrappedObject.ReverseRelation; set => WrappedObject.ReverseRelation = value;}
        ...
        /// <inheritdoc/>
        public IStyleSheet Sheet { get => WrappedObject.Sheet; }

        private static readonly int SizesKey = HashCode.Combine(nameof(Sizes));
        /// <inheritdoc/>
        public ISettableTokenList Sizes { get => GetOrWrap(SizesKey, () => WrappedObject.Sizes); }
