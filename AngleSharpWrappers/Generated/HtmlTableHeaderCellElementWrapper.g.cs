...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTableHeaderCellElement"/> type.
    /// </summary>
    public partial class HtmlTableHeaderCellElementWrapper : Wrapper<IHtmlTableHeaderCellElement>, IHtmlTableHeaderCellElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTableHeaderCellElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlTableHeaderCellElementWrapper(Func<IHtmlTableHeaderCellElement?> getObject) : base(getObject) { }
        ...
        /// <inheritdoc/>
        public Int32 ColumnSpan { get => WrappedObject.ColumnSpan; set => WrappedObject.ColumnSpan = value;}
        ...
        private static readonly int HeadersKey = HashCode.Combine(nameof(Headers));
        /// <inheritdoc/>
        public ISettableTokenList Headers { get => GetOrWrap(HeadersKey, () => WrappedObject.Headers); }
        ...
        /// <inheritdoc/>
        public Int32 RowSpan { get => WrappedObject.RowSpan; set => WrappedObject.RowSpan = value;}

        /// <inheritdoc/>
        public String Scope { get => WrappedObject.Scope; set => WrappedObject.Scope = value;}
