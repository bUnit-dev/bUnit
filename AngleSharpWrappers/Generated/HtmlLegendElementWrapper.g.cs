...
namespace AngleSharpWrappers
{
    ...
    /// </summary>
    public partial class HtmlLegendElementWrapper : Wrapper<IHtmlLegendElement>, IHtmlLegendElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlLegendElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlLegendElementWrapper(Func<IHtmlLegendElement?> getObject) : base(getObject) { }
