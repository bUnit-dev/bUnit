...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTableDataCellElement"/> type.
    /// </summary>
    public partial class HtmlTableDataCellElementWrapper : Wrapper<IHtmlTableDataCellElement>, IHtmlTableDataCellElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTableDataCellElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlTableDataCellElementWrapper(Func<IHtmlTableDataCellElement?> getObject) : base(getObject) { }
