...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlInlineFrameElement"/> type.
    /// </summary>
    public partial class HtmlInlineFrameElementWrapper : Wrapper<IHtmlInlineFrameElement>, IHtmlInlineFrameElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlInlineFrameElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlInlineFrameElementWrapper(Func<IHtmlInlineFrameElement?> getObject) : base(getObject) { }
        ...
        private static readonly int ContentDocumentKey = HashCode.Combine(nameof(ContentDocument));
        /// <inheritdoc/>
        public IDocument ContentDocument { get => GetOrWrap(ContentDocumentKey, () => WrappedObject.ContentDocument); }

        /// <inheritdoc/>
        public String ContentEditable { get => WrappedObject.ContentEditable; set => WrappedObject.ContentEditable = value;}

        /// <inheritdoc/>
        public String ContentHtml { get => WrappedObject.ContentHtml; set => WrappedObject.ContentHtml = value;}

        /// <inheritdoc/>
        public IWindow ContentWindow { get => WrappedObject.ContentWindow; }
        ...
        /// <inheritdoc/>
        public Boolean IsFullscreenAllowed { get => WrappedObject.IsFullscreenAllowed; set => WrappedObject.IsFullscreenAllowed = value;}

        /// <inheritdoc/>
        public Boolean IsHidden { get => WrappedObject.IsHidden; set => WrappedObject.IsHidden = value;}

        /// <inheritdoc/>
        public Boolean IsPaymentRequestAllowed { get => WrappedObject.IsPaymentRequestAllowed; set => WrappedObject.IsPaymentRequestAllowed = value;}

        /// <inheritdoc/>
        public Boolean IsSeamless { get => WrappedObject.IsSeamless; set => WrappedObject.IsSeamless = value;}
        ...
        /// <inheritdoc/>
        public String ReferrerPolicy { get => WrappedObject.ReferrerPolicy; set => WrappedObject.ReferrerPolicy = value;}

        private static readonly int SandboxKey = HashCode.Combine(nameof(Sandbox));
        /// <inheritdoc/>
        public ISettableTokenList Sandbox { get => GetOrWrap(SandboxKey, () => WrappedObject.Sandbox); }
