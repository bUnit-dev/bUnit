...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlTemplateElement"/> type.
    /// </summary>
    public partial class HtmlTemplateElementWrapper : Wrapper<IHtmlTemplateElement>, IHtmlTemplateElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlTemplateElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlTemplateElementWrapper(Func<IHtmlTemplateElement?> getObject) : base(getObject) { }
        ...
        private static readonly int ContentKey = HashCode.Combine(nameof(Content));
        /// <inheritdoc/>
        public IDocumentFragment Content { get => GetOrWrap(ContentKey, () => WrappedObject.Content); }
