...
namespace AngleSharpWrappers
{
    ...
    public partial class HtmlInputElementWrapper : Wrapper<IHtmlInputElement>, IHtmlInputElement, IWrapper
    {
        ...
        public HtmlInputElementWrapper(Func<IHtmlInputElement?> getObject) : base(getObject) { }
        ...
        private static readonly int FilesKey = HashCode.Combine(nameof(Files));
        /// <inheritdoc/>
        public IFileList Files { get => GetOrWrap(FilesKey, () => WrappedObject.Files); }
        ...
        private static readonly int ListKey = HashCode.Combine(nameof(List));
        /// <inheritdoc/>
        public IHtmlDataListElement List { get => GetOrWrap(ListKey, () => WrappedObject.List); }
