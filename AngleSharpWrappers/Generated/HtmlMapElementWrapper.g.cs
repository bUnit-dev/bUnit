...
namespace AngleSharpWrappers
{
    #nullable enable
    /// <summary>
    /// Represents a wrapper class around <see cref="IHtmlMapElement"/> type.
    /// </summary>
    public partial class HtmlMapElementWrapper : Wrapper<IHtmlMapElement>, IHtmlMapElement, IWrapper
    {
        /// <summary>
        /// Creates an instance of the <see cref="HtmlMapElementWrapper"/> type;
        /// </summary>
        /// <param name="getObject">A function that can be used to retrieve a new instance of the wrapped type.</param>
        public HtmlMapElementWrapper(Func<IHtmlMapElement?> getObject) : base(getObject) { }
        ...
        private static readonly int AreasKey = HashCode.Combine(nameof(Areas));
        /// <inheritdoc/>
        public IHtmlCollection<IHtmlAreaElement> Areas { get => GetOrWrap(AreasKey, () => WrappedObject.Areas); }
