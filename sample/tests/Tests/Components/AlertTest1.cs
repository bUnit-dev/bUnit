...
{
    public class AlertTest1 : ComponentTestFixture
    {
        public AlertTest1()
        {
        ...
        public void Test002()
        {
            ...
            var cut = RenderComponent<Alert>(
                ...
                ChildContent<Egil.RazorComponents.Testing.SampleApp.Components.Paragraph>(
                    (nameof(Egil.RazorComponents.Testing.SampleApp.Components.Paragraph.IsLast), true),
                    ChildContent(content)
                )
            );
